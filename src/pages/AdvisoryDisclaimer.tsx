  ...
  return (
    <LegalPageLayout title="Advisory Disclaimer">
      <section>
        ...
        <p>
          AeroVisa Global is an advisory and coordination platform. We are not an investment firm or immigration law firm. 
      ...
      <section>
        ...
        <p>
          Information provided regarding Residency by Investment programs is for advisory purposes only. 
